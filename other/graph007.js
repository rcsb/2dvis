...
function prepareGraph(){
  ...
  document.addEventListener( "DOMContentLoaded", function(){
    ...
    var ligandId = NGL.getQuery("ligandId") || "RET";
    stage.loadFile( "http://files.rcsb.org/ligands/download/" + ligandId + ".cif", {
       ...
       // comp.addRepresentation( "axes", { sele: "/0 and not #H", scale: 0.3 } );
        ...
        s.eachAtom( function( ap ){
          ...
          bbbb = ( plane.projectPoint(tempV)).dot( bv ); 
            ...
            graph.nodes.push(
              {id: ap.atomname, group: "1", size: "4", bond: "1", atom: ap.clone(), ring: true, 
